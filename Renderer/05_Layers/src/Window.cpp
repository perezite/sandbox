...
namespace sb 
{
	...
	void Window::draw(Drawable* drawable, const RenderStates& states) 
	{
		drawable->draw(*this, states);
	}

	void Window::draw(const std::vector<Vertex>& vertices, const PrimitiveType primitiveType, const RenderStates& states)
	{
